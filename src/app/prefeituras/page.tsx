...
const pillars = [
  {
    icon: HeartPulse,
    title: 'Carteira de saúde cidadã',
    text: 'O cidadão organiza exames, medicamentos, histórico, Passport, dados familiares e informações relevantes em uma experiência simples.',
  },
  {
    icon: Users,
    title: 'Família, idosos e dependentes',
    text: 'Perfis familiares livres para filhos, pais, idosos, cuidadores e pessoas acompanhadas, sem aceite ou assinatura obrigatória para o cuidado familiar.',
  },
  {
    icon: ShieldCheck,
    title: 'Dados autorizados',
    text: 'Profissionais e equipes acessam somente dados compartilhados pelo cidadão, por código, consulta ou autorização contextual.',
  },
  {
    icon: Video,
    title: 'Teleatendimento e triagem',
    text: 'Base para teleconsulta, orientação remota, acompanhamento de casos e extensão digital de equipes municipais quando fizer sentido.',
  },
  {
    icon: MessageCircle,
    title: 'Campanhas e lembretes',
    text: 'CRM SmartBots para lembrar retornos, exames, consultas, medicamentos, grupos prioritários, crônicos, gestantes, idosos e prevenção.',
  },
  {
    icon: FileText,
    title: 'Documentação e acompanhamento',
    text: 'Relatórios, orientações, timeline e histórico de interações ajudam a manter continuidade do cuidado entre cidadão, família e equipe.',
  },
]
...
const journey = [
  {
    step: '1',
    title: 'Cidadão organiza dados',
    text: 'HealthWallet reúne documentos, exames, medicamentos, Passport e dados familiares.',
  },
  {
    step: '2',
    title: 'Família acompanha',
    text: 'Cuidadores e responsáveis mantêm informações úteis para rotina e emergência.',
  },
  {
    step: '3',
    title: 'Equipe acessa com autorização',
    text: 'Profissionais veem apenas o que foi compartilhado, com foco em atendimento e continuidade.',
  },
  {
    step: '4',
    title: 'Município cria programas',
    text: 'Secretaria estrutura pilotos, campanhas e acompanhamento remoto por público prioritário.',
  },
  {
    step: '5',
    title: 'Cuidado vira jornada',
    text: 'Lembretes, retorno, teleatendimento e CRM reduzem abandono e melhoram acompanhamento.',
  },
]
    ...
    <main className="max-w-7xl mx-auto px-4 py-10 space-y-14">
        ...
        <div className="relative grid lg:grid-cols-[1.08fr_0.92fr] gap-10 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm text-emerald-100 mb-6">
              ...
              Saúde digital cidadã
            </div>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Uma camada digital simples para melhorar a jornada de saúde do cidadão.
            </h1>
            <p className="text-lg text-white/75 mt-5 max-w-3xl">
              O HealthWallet organiza dados de saúde pessoais e familiares. O MyDataMed permite que profissionais, equipes, clínicas parceiras e programas públicos acessem informações autorizadas, façam teleatendimento, acompanhem retornos e mantenham cuidado contínuo.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              <a href="#piloto" className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 py-4 font-semibold text-white hover:bg-emerald-600">
                Desenhar piloto municipal
                <ArrowRight className="w-5 h-5" />
              </a>
              <Link href="/tour#prefeituras" className="inline-flex items-center justify-center gap-2 rounded-xl bg-white/10 border border-white/15 px-6 py-4 font-semibold text-white hover:bg-white/15">
                Ver tour para secretarias
              </Link>
            </div>
          </div>
      ...
      <section className="space-y-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mt-3">
            A proposta é começar modular: cidadão, família, profissionais cadastrados, dados autorizados, teleatendimento, lembretes e acompanhamento por programa.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-8 items-start">
          <div>
            ...
            <p className="text-gray-600 mt-4">
              A entrada ideal para prefeitura ou secretaria é um piloto com escopo claro: uma UBS, um grupo prioritário, um programa municipal ou um conjunto de profissionais parceiros.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 gap-3">
            {programs.map((item) => (
              <div key={item} className="rounded-2xl bg-white border border-gray-100 p-4 shadow-sm flex gap-2 text-sm text-gray-700">
      ...
      <section className="grid lg:grid-cols-2 gap-6">
        <div className="rounded-[2rem] bg-white border border-gray-100 shadow-sm p-6 md:p-8">
          ...
          <p className="text-gray-600 mt-3">
            Profissionais cadastrados acessam dados autorizados gratuitamente. O modo Pro libera teleconsulta, CRM, documentos, assinatura profissional e pagamentos quando aplicável ao modelo operacional.
          </p>
          <div className="space-y-2 mt-5">
            <Check text="Acesso por código ou autorização do cidadão" />
            <Check text="Snapshot com exames, medicamentos, timeline e Passport" />
            <Check text="Teleconsulta Daily embutida e fallback externo" />
            <Check text="CRM para retornos e acompanhamento" />
          </div>
        </div>

        <div className="rounded-[2rem] bg-slate-950 text-white shadow-sm p-6 md:p-8">
          <div className="w-12 h-12 rounded-2xl bg-white/10 text-emerald-200 flex items-center justify-center mb-4">
            <Landmark className="w-6 h-6" />
          </div>
          <h2 className="text-2xl font-bold">Para gestão pública</h2>
          <p className="text-white/70 mt-3">
            A secretaria pode usar o ecossistema como camada de relacionamento, organização de jornada e apoio digital ao cidadão, respeitando escopo, governança, segurança e responsabilidades de cada programa.
          </p>
          <div className="space-y-2 mt-5">
            <CheckDark text="Piloto por programa, UBS, grupo prioritário ou região" />
            <CheckDark text="Cidadão com dados organizados e família acompanhando" />
            <CheckDark text="Campanhas, lembretes e retornos com SmartBots" />
            <CheckDark text="Modelo modular para convênios e parcerias" />
          </div>
        </div>
      </section>
      ...
      <section className="rounded-[2rem] bg-white border border-gray-100 shadow-sm p-8 md:p-12 text-center">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto mt-3">
          A apresentação ideal para prefeitura é objetiva: problema, solução, piloto, módulos, segurança, benefícios ao cidadão e expansão por fases.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
          <Link href="/tour" className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 text-white px-6 py-4 font-semibold hover:bg-emerald-700">
            Ver tour completo
            <ArrowRight className="w-5 h-5" />
          </Link>
          <Link href="/register" className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 text-gray-700 px-6 py-4 font-semibold hover:bg-gray-50">
